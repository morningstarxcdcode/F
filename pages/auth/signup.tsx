...
export default function SignUp() {
  ...
  const checkPasswordStrength = (password: string) => {
    ...
    setPasswordStrength({ score, message: feedback });
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-green-50 to-green-100 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Join thousands of vendors and suppliers</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
              >
                <option value="vendor">Vendor (Buy from suppliers)</option>
                <option value="supplier">Supplier (Sell to vendors)</option>
              </select>
            </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-green-50 to-green-100 py-12 px-4 sm:px-6 lg:px-8">
